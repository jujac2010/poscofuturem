...
export default function Home() {
  ...
  // 처리 완료·dismissed 경보는 정비 이력으로 이동하고, 현재 조치가 필요한 항목만 큐에 남깁니다.
  const activeMaintenanceAssessments = maintenanceAssessments.filter((assessment) => !["COMPLETED", "DISMISSED"].includes(assessment.status));
